...
resource "aws_security_group" "rds" {
  ...
  description = "Security group para RDS databases"
  vpc_id      = aws_vpc.main.id
  ...
  ingress {
    ...
    to_port         = 3306
    protocol        = "tcp"
    security_groups = [aws_security_group.lambda.id, aws_security_group.django.id]
  }
